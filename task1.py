...
b1 = tk.Button(win, image=vineboomimg)
b2 = tk.Button(win, image=bounceimg)
b3 = tk.Button(win, image=amongusimg)
b4 = tk.Button(win, image=minecraftimg)
b5 = tk.Button(win, image=suspenseimg)
b6 = tk.Button(win, image=emoimg)
